        ...
        <div className=''>
            ...
            <div className="flex justify-center  absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]  z-10">
                <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                    ...
                    <Link href='/products' className="px-12 py-4 rounded-full bg-[#202938bb] font-bold text-white tracking-widest shadow-md uppercase transform hover:scale-105 hover:bg-[#fff] hover:text-[#000] transition-colors duration-200">
                        Explore Our Store
                    </Link>
